...
for result in results:
    ...
    # if policyNum != '21NJN00122':
    #     continue
    try:
        if policy_json['payments']['paymentType'] == '10% Down 9 Installments':
            policy_json['payments']['paymentType'] = '10% Deposit Plus 9 Monthly Installments-$10 FEE'
        #policy_json['payments']['paymentType'] = driverReportPolicy['WORK-BOOK - PAYMENT RECEIVED'].values[0]
    except:
        continue
        # try:
